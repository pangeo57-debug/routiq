...
8. **`reduceZigzag()`** — exchanges the time positions of two lessons where it shortens the day's driving, untangling a day that bounces between areas
...
92 tests, zero dependencies — just the built-in `node:test` runner (Node 18+).
